...
class TestUploadEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_upload_success_jpg(self, client: AsyncClient, test_image_jpg, test_submission_data):
        """Test successful photo upload with JPG."""
        files = {"photo": ("test.jpg", test_image_jpg, "image/jpeg")}
        response = await client.post("/api/v1/submissions/upload", data=test_submission_data, files=files)
    ...
    @pytest.mark.asyncio
    async def test_upload_success_png(self, client: AsyncClient, test_image_png, test_submission_data):
    ...
    @pytest.mark.asyncio
    async def test_upload_invalid_file_type(self, client: AsyncClient, test_submission_data):
    ...
    @pytest.mark.asyncio
    async def test_upload_invalid_age(self, client: AsyncClient, test_image_jpg, test_submission_data_invalid_age):
        """Test upload with invalid age."""
        files = {"photo": ("test.jpg", test_image_jpg, "image/jpeg")}
        response = await client.post("/api/v1/submissions/upload", data=test_submission_data_invalid_age, files=files)
        
        assert response.status_code == 422  # Validation error
    
    @pytest.mark.asyncio
    async def test_upload_missing_required_field(self, client: AsyncClient, test_image_jpg):
        ...
        files = {"photo": ("test.jpg", test_image_jpg, "image/jpeg")}
        response = await client.post("/api/v1/submissions/upload", data=incomplete_data, files=files)
        
        assert response.status_code == 422  # Validation error
    
    @pytest.mark.asyncio
    async def test_upload_missing_photo(self, client: AsyncClient, test_submission_data):
        """Test upload without photo file."""
        response = await client.post("/api/v1/submissions/upload", data=test_submission_data)
        
        assert response.status_code == 422  # Validation error
    
    @pytest.mark.asyncio
    async def test_upload_age_boundary_min(self, client: AsyncClient, test_image_jpg, test_submission_data):
    ...
    @pytest.mark.asyncio
    async def test_upload_age_boundary_max(self, client: AsyncClient, test_image_jpg, test_submission_data):
    ...
    @pytest.mark.asyncio
    async def test_upload_age_below_min(self, client: AsyncClient, test_image_jpg, test_submission_data):
    ...
    @pytest.mark.asyncio
    async def test_upload_age_above_max(self, client: AsyncClient, test_image_jpg, test_submission_data):
