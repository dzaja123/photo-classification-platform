...
class SubmissionFilters(BaseModel):
    ...
    classification_status: Optional[str] = Field(None, description="Classification status")
    classification_result: Optional[str] = Field(None, description="Classification result class")
