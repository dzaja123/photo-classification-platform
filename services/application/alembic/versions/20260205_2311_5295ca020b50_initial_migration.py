...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_submissions_classification_status"),
        "submissions",
        ["classification_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_submissions_created_at"), "submissions", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_submissions_is_deleted"), "submissions", ["is_deleted"], unique=False
    )
    op.create_index(
        op.f("ix_submissions_photo_path"), "submissions", ["photo_path"], unique=True
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_submissions_classification_status"), table_name="submissions"
    )
