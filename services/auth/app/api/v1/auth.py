...
from app.api.dependencies import get_auth_service, get_client_ip, get_user_agent
...
async def refresh_token(
    ...
    **Note:** Old refresh token will be revoked
    ...
    tokens = await auth_service.refresh_tokens(
        refresh_token=refresh_data.refresh_token, ip_address=ip_address
    )

    return APIResponse(
        success=True, message="Token refreshed successfully", data=tokens
    )
