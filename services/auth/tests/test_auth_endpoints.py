...
class TestRegisterEndpoint:
    ...
    async def test_register_invalid_email(
        self, client: AsyncClient, test_user_data_invalid_email
    ):
        """Test registration with invalid email."""
        response = await client.post(
            "/api/v1/auth/register", json=test_user_data_invalid_email
        )
    ...
    async def test_register_weak_password(
        self, client: AsyncClient, test_user_data_weak_password
    ):
        """Test registration with weak password."""
        response = await client.post(
            "/api/v1/auth/register", json=test_user_data_weak_password
        )
    ...
    async def test_register_reserved_username(
        self, client: AsyncClient, test_user_data_reserved_username
    ):
        """Test registration with reserved username."""
        response = await client.post(
            "/api/v1/auth/register", json=test_user_data_reserved_username
        )
